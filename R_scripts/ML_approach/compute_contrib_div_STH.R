...
strat_in <- readRDS(file = "/data1/gdouglas/projects/contrib_div/data/curatedMetagenomicData_ML/input/pathway_tables.rds")$STH$strat
...
STH_contrib_div_out <- mclapply(X = div_metrics,
                                FUN = run_div_metric_strat_long,
                                strat_tab = strat_in,
                                mc.cores = length(div_metrics))

names(STH_contrib_div_out) <- div_metrics

saveRDS(object = STH_contrib_div_out,
        file = "/data1/gdouglas/projects/contrib_div/data/curatedMetagenomicData_ML/input/computed_metrics/STH_contrib_div_out.rds")
