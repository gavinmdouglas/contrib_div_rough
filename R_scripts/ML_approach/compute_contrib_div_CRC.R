...
strat_in <- readRDS(file = "/data1/gdouglas/projects/contrib_div/data/curatedMetagenomicData_ML/input/pathway_tables.rds")$CRC$strat
...
names(CRC_contrib_div_out) <- div_metrics
